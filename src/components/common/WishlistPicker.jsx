    ...
    <>
      ...
      <div className={styles.picker}>
        <div className={styles.head}>
          ...
          <button onClick={closeWishlistPicker} className={styles.close}>
            <X size={18} />
          </button>
        </div>
          ...
          {wishlists.map(wl => {
            ...
            return (
              ...
              >
                ...
                {isIn && <Check size={14} className={styles.checkIcon} />}
              </button>
            );
          })}
        </div>
        ...
        <div className={styles.footer}>
          {creating ? (
            <div className={styles.newListForm}>
              ...
              <button className={styles.newListCancel} onClick={() => setCreating(false)}>
                <X size={14} />
              </button>
            </div>
          ) : (
