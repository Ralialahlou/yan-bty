export const brands = [
  ...
  { id: 'nars', name: 'NARS', slug: 'nars', isOwn: false, logo: null, tagline: 'Fearlessly bold makeup', color: '#1a1a1a' },
  {
    ...
    isOwn: false,
    logo: null,
    tagline: 'Hollywood beauty secrets',
    color: '#c4933f',
    heroImage: 'https://images.ctfassets.net/wlke2cbybljx/2NIp3FZpM5FuhUU6r109m5/9e048f3088935eb8199f141a900f8e9d/ES_SERUM-MODEL-2000x2000__1_.jpg',
    heroBody: 'Founded by makeup artist to the stars Charlotte Tilbury MBE, the brand fuses science-backed formulas with Hollywood glamour — for skin and makeup that makes you feel extraordinary.',
    iconProductIds: ['ct-005', 'ct-003', 'ct-001'],
  },
  ...
  { id: 'kiehls', name: "Kiehl's", slug: 'kiehls', isOwn: false, logo: null, tagline: 'New York apothecary since 1851', color: '#2d4a22' },
  { id: 'urban-decay', name: 'Urban Decay', slug: 'urban-decay', isOwn: false, logo: null, tagline: 'Beauty with an edge', color: '#6b21a8' },
  { id: 'fenty-beauty', name: 'Fenty Beauty', slug: 'fenty-beauty', isOwn: false, logo: null, tagline: 'Beauty for all', color: '#c2410c' },
